...
- Truthfully referring to the CodexNotch project.
- Linking to the official repository or product page.
- Stating that a project is based on, compatible with, or forked from CodexNotch, as long as the statement does not imply endorsement.
- Using screenshots for commentary, reviews, education, or documentation.
...
For brand-permission questions, open an issue in the official repository without including confidential information.
